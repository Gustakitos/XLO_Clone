...
mixin _$CreateStore on _CreateStoreBase, Store {
  ...
  @override
  bool get cepValid =>
      (_$cepValidComputed ??= Computed<bool>(() => super.cepValid,
              name: '_CreateStoreBase.cepValid'))
          .value;
  ...
  final _$cepAtom = Atom(name: '_CreateStoreBase.cep');
